...
public class Settings extends GenericSettings {
    ...
    public Settings() {
        ...
        properties.put(RECONNECTION_INTERVAL, new ServiceProperty(RECONNECTION_INTERVAL,
                "Interval in seconds to wait before deleting the connection and trying to reconnect", null, false));
