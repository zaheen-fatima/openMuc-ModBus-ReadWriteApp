...
public class AmqpSettings {
     ...
     *            Inteval in seconds to wait before deleting the connection and trying to reconnect
     */
    public AmqpSettings(String host, int port, String virtualHost, String username, String password, boolean ssl,
            ...
            int connectionAliveInterval, int reconnectionInterval) {
        this.host = host;
        this.port = port;
    ...
    public String toString() {
        ...
        sb.append("reconnectionInterval = " + reconnectionInterval + "\n");
