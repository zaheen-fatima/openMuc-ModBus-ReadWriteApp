...
public class DeviceConnectionTest {
    ...
    @Test
    public void testCsvWithoutHhmmss() throws ConnectionException, ArgumentSyntaxException {
    ...
    @Test
    public void testCsvWithUnixtimestamp() throws ConnectionException, ArgumentSyntaxException {
        String deviceAddress = DIR + "test_data.csv";
    ...
    @Test
    public void testCsvWithoutUnixtimestamp() throws ConnectionException, ArgumentSyntaxException {
