...
public class Aggregator implements DriverService, Connection {
    ...
    public DriverInfo getInfo() {
        ...
        String description = "Is able to aggregate logged values of a channel over time and writes the aggregated value into a new channel. Different aggregation types supported: AVG, LAST, DIFF, PULS_ENERGY";
