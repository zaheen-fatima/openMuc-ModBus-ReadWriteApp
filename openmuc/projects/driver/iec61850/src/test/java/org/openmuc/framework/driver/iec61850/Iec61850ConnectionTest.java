...
public class Iec61850ConnectionTest extends Thread implements ClientEventListener, ServerEventListener {
    ...
    public void testScanForChannels()
        ...
        for (int i = 14; i < 23; i++) {
            ...
            assertEquals("BYTE_ARRAY", testChannelScanList.get(i).getValueType().toString());
        }
        assertEquals("LONG", testChannelScanList.get(23).getValueType().toString());
        assertEquals("BOOLEAN", testChannelScanList.get(24).getValueType().toString());
        assertEquals("FLOAT", testChannelScanList.get(25).getValueType().toString());
        assertEquals("DOUBLE", testChannelScanList.get(26).getValueType().toString());
        assertEquals("BYTE", testChannelScanList.get(27).getValueType().toString());
        assertEquals("SHORT", testChannelScanList.get(28).getValueType().toString());
        assertEquals("SHORT", testChannelScanList.get(29).getValueType().toString());
        assertEquals("INTEGER", testChannelScanList.get(30).getValueType().toString());
        assertEquals("INTEGER", testChannelScanList.get(31).getValueType().toString());
        assertEquals("LONG", testChannelScanList.get(32).getValueType().toString());
        assertEquals("LONG", testChannelScanList.get(33).getValueType().toString());
        assertEquals("BYTE_ARRAY", testChannelScanList.get(34).getValueType().toString());
    ...
    public void testRead()
        ...
        assertEquals("[64]", testRecordContainers.get(0).getRecord().getValue().toString());
    ...
    public void testWrite()
        ...
        assertEquals("[68]", testRecordContainers.get(14).getRecord().getValue().toString());
        assertEquals("12.5", testRecordContainers.get(25).getRecord().getValue().toString());
        assertEquals("true", testRecordContainers.get(24).getRecord().getValue().toString());
    }
