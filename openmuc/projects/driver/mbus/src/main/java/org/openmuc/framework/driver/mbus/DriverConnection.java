...
public class DriverConnection implements Connection {
    ...
    private String getDescription(DataRecord dataRecord) {
        ...
        final String valuePlaceHolder = ";Value:";
        final String scaledValueString = ";ScaledValue:";

        switch (dataValueType) {
        case DATE:
        case STRING:
            builder.append(valuePlaceHolder).append((dataValue).toString());
            break;
        case DOUBLE:
        ...
        case LONG:
            if (multiplierExponent == 0) {
                builder.append(valuePlaceHolder).append(dataValue);
            }
            else {
                builder.append(scaledValueString).append(scaledDataValue);
            }
    ...
    public Object read(List<ChannelRecordContainer> containers, Object containerListHandle, String samplingGroup)
        ...
        synchronized (connectionInterface) {
            ...
            String[] dibVibs = getDibVibs(dataRecords);
    ...
    private String[] getDibVibs(List<DataRecord> dataRecords) {
        int i = 0;
    ...
    private boolean setRecords(List<ChannelRecordContainer> containers, MBusConnection mBusConnection, long timestamp,
        ...
        for (ChannelRecordContainer container : containers) {
            ...
            if (channelAddress.startsWith("X")) {
                ...
                VariableDataStructure variableDataStructure2;
                try {
    ...
    private void sleep(long milliseconds) throws ConnectionException {
        if (milliseconds > 0) {
            try {
