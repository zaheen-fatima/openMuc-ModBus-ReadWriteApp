...
public class DriverTest {
    ...
    public void testDeviceSettings_OK() throws ArgumentSyntaxException {
        int expectedMFT = 123;
        int expectedCFL = 321;
        String expectedAT = "1,2,3,36";
        String string = "mft " + TS + expectedMFT + SEP + "cfl " + TS + expectedCFL + SEP + "at" + TS + expectedAT;
        ...
        assertEquals(expectedAT, testSetting.allowedTypes());
    }
