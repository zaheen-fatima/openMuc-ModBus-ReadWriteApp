...
public class DeviceSettings extends GenericSetting {
    ...
    protected int connection_timeout = -1;
    ...
    protected int max_num_of_outstanding_ipdus = -1;
    ...
    public static enum Option implements OptionI {
        ...
        CONNECTION_TIMEOUT("cont", Integer.class, false),
        ...
        MAX_NUM_OF_OUTSTANDING_IPDUS("mnoi", Integer.class, false),
        ALLOWED_TYPES("at", String.class, false),
    ...
    public int maxNumOfOutstandingIPdus() {
        return max_num_of_outstanding_ipdus;
    }
