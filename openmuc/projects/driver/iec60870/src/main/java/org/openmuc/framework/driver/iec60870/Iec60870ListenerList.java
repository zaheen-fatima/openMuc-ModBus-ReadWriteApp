...
class Iec60870ListenerList implements ConnectionEventListener {
    ...
    @Override
    public void newASdu(org.openmuc.j60870.Connection jConnectionASdu, ASdu aSdu) {
        for (ConnectionEventListener connectionEventListener : connectionEventListeners) {
            connectionEventListener.newASdu(jConnectionASdu, aSdu);
        }
    }
    ...
    public void connectionClosed(org.openmuc.j60870.Connection jConnectionASdu, IOException e) {
        for (ConnectionEventListener connectionEventListener : connectionEventListeners) {
            connectionEventListener.connectionClosed(jConnectionASdu, e);
        }
    }
